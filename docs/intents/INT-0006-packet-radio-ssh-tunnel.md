...
- **Intent ID:** INT-0006
- **State:** realized
- **Review evidence:** [Sprint 9 research report](../sprints/s9/sprint-research/research-report.md) — criterion 2 found unmet; [Sprint 2 research report](../sprints/s2/sprint-research/research-report.md) — audit found criterion 4's stream bridge has no runtime; [Sprint 7 research report](../sprints/s7/sprint-research/research-report.md) — confirmed and scoped.
...
Verification note on criterion 2 (added 2026-08-24): the ARQ layer implements
